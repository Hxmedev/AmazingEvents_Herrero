        ...
        tr.innerHTML=`
            <th scope="row" colspan="2">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <img class="card-img-top cover" style="min-height:100%" src="${highest[i].image}" alt="Card image cap">
                        </div>
                        <div class="col">
                            <div class="col">
            ...
            <th scope="row">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                            <h5 class="text-info text-center">Audience: <span class="text-success">${capacity[i].capacity}</span></h5>
                        </div>
                    </div>
                </div>
                </div>
